...
vim.keymap.set("n", "<C-S-h>", ":wincmd H<CR>", { noremap = true })
vim.keymap.set("n", "<C-S-l>", ":wincmd L<CR>", { noremap = true })
vim.keymap.set("n", "<C-S-j>", ":wincmd J<CR>", { noremap = true })
vim.keymap.set("n", "<C-S-k>", ":wincmd K<CR>", { noremap = true })
